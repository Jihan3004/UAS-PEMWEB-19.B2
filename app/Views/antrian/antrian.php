                        ...
                        <div class="hero-copy">
                            ...
                            <h1 class="hero-paragraph is-revealing">
                                ...
                                <?php 
                                 ...
                                 if ($s == '4') {
                                                       echo "Anda Telah mengambil no antrian untuk customer service dengan no antrian THT".$a;               
                                                                   }  elseif ($s == '5') {
                                                                       echo "Anda Telah mengambil no antrian untuk pengaduan dengan no antrian Anak".$a;   
                                                                   }  elseif ($s == '6') {
                                                                       echo "Anda Telah mengambil no antrian untuk Permohonan Baru dengan no antrian Penyakit Dalam".$a;   
                                                                   } elseif ($s == '7') {
                                                                       echo "Anda Telah mengantrian untuk Perpanjang dengan no antrian Gigi".$a;   
                                                                   }                   
                                ?>
