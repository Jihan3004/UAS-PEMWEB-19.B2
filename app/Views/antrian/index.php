                        ...
                        <div class="features-wrap">
                            ...
                            <div class="feature is-revealing">
                                ...
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile">Dokter THT</h4>
                                    <p class="text-sm">Antrian ini untuk pelayanan spesialis THT</p>
                                </div>
                                </a>
                            </div>
                            <div class="feature is-revealing">
                                ...
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile">Dokter Anak</h4>
                                    <p class="text-sm">Antrian ini untuk pelayanan spesialis anak.</p>
                                </div>
                                </a>
                            </div>
                            <div class="feature is-revealing">
                                ...
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile">Dokter Penyakit Dalam</h4>
                                    <p class="text-sm">Antrian ini untuk pelayanan spesialis penyakit dalam.</p>
                                </div>
                                </a>
                            </div>
                            <div class="feature is-revealing">
                                ...
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile">Dokter Gigi</h4>
                                    <p class="text-sm">Antrian ini untuk pelayanan spesialis gigi.</p>
                                </div>
                                </a>
                            </div>
                        </div>
        ...
        <footer class="site-footer text-light">
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    ...
                    <div class="footer-copyright">&copy; 2021 Syahrul, all rights reserved</div>
                </div>
            </div>
        </footer>
    </div>
